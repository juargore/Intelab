...
import com.intelab.joblab.domain.entities.Detail
...
class JoblabDialog(val context: Context) : BaseDialogHelper() {
    ...
    private val detailButton: TextView = dialogView.findViewById(R.id.tv_detail)

    val detailMessage: TextView = dialogView.findViewById(R.id.tv_message_detail)
    ...
    private fun detailsClickListener() = with(detailButton) {
